...
/** Load controller, transfer data from remote memory (virtual address) to local scratchpad (physical address)
  ...
  */
class LoadController(spadAddrWidth: Int, spadAddrNum: Int, lgMaxPartitionSize: Int, lgMaxDataLen: Int, dataWidth: Int, hasMask: Boolean, idWidth: Int, streamQueDepth: Int, reqQueDepth: Int)
